...
const GiveMonthly = () => {
    return (
        <div className='grid grid-cols-1 md:grid-cols-3 max-w-3xl mx-auto my-10 space-y-5'>
            <div className='text-center space-y-5'>
                <div className='flex ml-40 md:ml-28 bg-orange-500 rounded-full w-14 p-5'><GiVendingMachine></GiVendingMachine></div>
                <p>Give Now</p>
            ...
            <div className='text-center space-y-5'>
                <div className='flex ml-40 md:ml-28 bg-orange-500 rounded-full w-14 p-5'><MdOutlineCalendarMonth></MdOutlineCalendarMonth></div>
                <p>Give Monthly</p>
            ...
            <div className='text-center space-y-5'>
                <div className='flex ml-40 md:ml-28 bg-orange-500 rounded-full w-14 p-5'><BiDonateBlood></BiDonateBlood></div>
                <p>Taking Donation</p>
